...
public class Swagger2Config {
    ...
    private ApiInfo apiInfo_PGN() {
        return new ApiInfoBuilder()
                .title("PGN的模块")
                .description("PGN的代码实现~")
                .version("2.0")
                .contact(new Contact("PGN", "https://github.com/PGN", "PGN@qq.com"))
                .build();
    }

    private ApiInfo apiInfo_NXY() {
        return new ApiInfoBuilder()
                .title("易烊千玺的模块")
