...
public class GlobalExceptionHandler {
    ...
    public ResultVO RuntimeException(RuntimeException e){
        //System.out.println(e.getMessage());
        return new ResultVO(5000,"操作异常，请稍后重试或者联系管理员！！！",false,e.getMessage());
    }

    @ExceptionHandler(value = MissingServletRequestParameterException.class)
    @ResponseBody
    public ResultVO excepMissingServletRequestParameterExceptiontion(MissingServletRequestParameterException e){
        //System.out.println(e.getMessage());
